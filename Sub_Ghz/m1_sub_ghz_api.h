...
#define SI446X_GRP_ID_0x22_PA_BIAS_CLKDUTY                                     \
  0x02 // PA bias and duty cycle of the Tx clock source.
...
#define START_TX_COMPLETE_STATE_NOCHANGE                                       \
  0b00000000 // Do not change from previously sent START_TX_COMPLETE_STATE.
