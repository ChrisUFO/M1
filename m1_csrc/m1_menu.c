...
S_M1_Menu_t menu_Sub_GHz_Record = {"Record", sub_ghz_record, NULL, NULL,  0,
                                   0,        NULL,           NULL, {NULL}};

S_M1_Menu_t menu_Sub_GHz_Replay = {"Replay", sub_ghz_replay, NULL, NULL,  0,
                                   0,        NULL,           NULL, {NULL}};

S_M1_Menu_t menu_Sub_GHz_Frequency_Reader = {"Frequency Reader",
...
S_M1_Menu_t menu_Sub_GHz_Regional_Information = {"Regional Information",
                                                 sub_ghz_regional_information,
                                                 NULL,
                                                 NULL,
                                                 0,
                                                 0,
...
S_M1_Menu_t menu_Sub_GHz_Radio_Settings = {"Radio Settings",
                                           sub_ghz_radio_settings,
                                           NULL,
                                           NULL,
                                           0,
                                           0,
...
S_M1_Menu_t menu_Sub_GHz = {"Sub-GHz",
                            NULL,
                            NULL,
                            NULL,
                            4,
                            ...
                            {&menu_Sub_GHz_Record, &menu_Sub_GHz_Replay,
                             &menu_Sub_GHz_Frequency_Reader,
                             &menu_Sub_GHz_Regional_Information}};
...
S_M1_Menu_t menu_125KHz_RFID = {
    ...
    menu_m1_icon_rfid,
    NULL,
    {&menu_125KHz_RFID_Read, &menu_125KHz_RFID_Saved,
     &menu_125KHz_RFID_Add_Manually, &menu_125KHz_RFID_Utilities}};
...
S_M1_Menu_t menu_Infrared_Universal_Remotes = {"Universal Remotes",
...
S_M1_Menu_t menu_Infrared = {"Infrared",
                             menu_infrared_init,
                             NULL,
                             NULL,
                             3,
                             0,
                             menu_m1_icon_infrared,
                             NULL,
                             {&menu_Infrared_Universal_Remotes,
                              &menu_Infrared_Learn_New_Remote,
                              &menu_Infrared_Saved_Remotes}};
...
S_M1_Menu_t menu_GPIO_USB_UART = {"USB-UART bridge",
...
S_M1_Menu_t menu_GPIO = {"GPIO",
                         ...
                         menu_m1_icon_gpio,
                         gpio_gui_update,
                         {&menu_GPIO_GPIO_Manual_Control,
                          &menu_GPIO_3_3V_On_GPIO, &menu_GPIO_5V_On_GPIO,
                          &menu_GPIO_USB_UART}};
...
S_M1_Menu_t menu_Setting_Power_Reboot = {"Reboot", power_reboot, NULL, NULL,  0,
                                         0,        NULL,         NULL, {NULL}};

S_M1_Menu_t menu_Setting_Power_Off = {"Power Off", power_off, NULL, NULL,  0,
                                      0,           NULL,      NULL, {NULL}};
...
S_M1_Menu_t menu_Setting_Firmware_Update_Image_File = {
    "Image File", firmware_update_get_image_file, NULL, NULL, 0, 0, NULL, NULL,
    {NULL}};

S_M1_Menu_t menu_Setting_Firmware_Update_Start = {"Firmware update",
...
S_M1_Menu_t menu_Setting_Firmware_Update_USB_DFU = {
    "USB DFU mode", firmware_update_usb_dfu_mode, NULL, NULL, 0, 0, NULL, NULL,
    {NULL}};
...
S_M1_Menu_t menu_Setting_ESP32_Image_File = {
    "Image File", setting_esp32_image_file, NULL, NULL, 0, 0, NULL, NULL,
    {NULL}};

S_M1_Menu_t menu_Setting_ESP32_Start_Address = {
    "Start Address", setting_esp32_start_address, NULL, NULL, 0, 0, NULL, NULL,
    {NULL}};

S_M1_Menu_t menu_Setting_ESP32_Firmware_Update = {"Firmware Update",
...
S_M1_Menu_t menu_Settings_Storage = {
    ...
    NULL,
    NULL,
    {&menu_Setting_Storage_About, &menu_Setting_Storage_Explore,
     &menu_Setting_Storage_Mount, &menu_Setting_Storage_Unmount,
     &menu_Setting_Storage_Format}};

S_M1_Menu_t menu_Settings_Power = {"Power",
                                   ...
                                   NULL,
                                   NULL,
                                   {&menu_Setting_Power_Info,
                                    &menu_Setting_Power_Reboot,
                                    &menu_Setting_Power_Off}};
...
S_M1_Menu_t menu_Setting_Firmware_Update = {
    ...
    0,
    NULL,
    firmware_update_gui_update,
    {&menu_Setting_Firmware_Update_Image_File,
     &menu_Setting_Firmware_Update_Start,
     &menu_Setting_Firmware_Update_USB_DFU}};

S_M1_Menu_t menu_Setting_ESP32 = {"ESP32 update",
                                  setting_esp32_init,
                                  setting_esp32_exit,
                                  setting_esp32_xkey_handler,
                                  3,
                                  0,
                                  NULL,
                                  setting_esp32_gui_update,
                                  {&menu_Setting_ESP32_Image_File,
                                   &menu_Setting_ESP32_Start_Address,
                                   &menu_Setting_ESP32_Firmware_Update}};

S_M1_Menu_t menu_Settings_About = {"About", settings_about, NULL, NULL,  0,
                                   0,       NULL,           NULL, {NULL}};
...
S_M1_Menu_t menu_Settings = {
    ...
    5,
    0,
    menu_m1_icon_setting,
    NULL,
    /*{&menu_Settings_LCD_and_Notifications,*/
    {&menu_Settings_Storage, &menu_Settings_Power,
     /* &menu_Settings_System,*/ &menu_Setting_Firmware_Update,
     &menu_Setting_ESP32, &menu_Settings_About}};
...
const S_M1_Menu_t menu_Main = {"Main Menu",
                               ...
                               NULL,
                               NULL,
                               {&menu_Sub_GHz, &menu_125KHz_RFID, &menu_NFC,
                                &menu_Infrared, &menu_GPIO, &menu_Wifi,
                                &menu_Bluetooth, &menu_Settings}};
...
static void menu_main_init(void) {
  ...
  menu_ctl.last_selected_items[0] =
      0; // last selected item is the current active item
...
void menu_main_handler_task(void *param) {
  ...
  vTaskDelay(POWER_UP_SYS_CONFIG_WAIT_TIME); // Give some time to
                                             // startup_config_handler() during
                                             // power-up
  while (1) {
    ...
    if (ret != pdTRUE) // This should never happen!
      continue; // Wait for a new notification when the attempt to read the
                // button event fails
    ...
    for (key = 0; key < NUM_BUTTONS_MAX; key++) {
      if (this_button_status.event[key] != BUTTON_EVENT_IDLE) {
        ...
        case BUTTON_OK_KP_ID:
          if (this_button_status.event[BUTTON_OK_KP_ID] == BUTTON_EVENT_CLICK) {
            if (m1_device_stat.op_mode == M1_OPERATION_MODE_MENU_ON) {
              n_items = pthis_submenu->submenu[menu_ctl.menu_item_active]
                            ->num_submenu_items; // get the number of submenu
                                                 // items of the selected item
              menu_ctl.last_selected_items[menu_ctl.menu_level] =
                  menu_ctl.menu_item_active; // save the selected item before
                                             // going the next menu level
              if (n_items != 0) // This menu item has another submenu?
              {
                menu_ctl.menu_level++; // go to next menu level
                menu_ctl.main_menu_ptr[menu_ctl.menu_level] =
                    pthis_submenu->submenu[menu_ctl.menu_item_active];
                pthis_submenu = menu_ctl.main_menu_ptr[menu_ctl.menu_level];
                menu_ctl.this_func = pthis_submenu->sub_func;
                ...
                if (menu_ctl.this_func != NULL) {
                  menu_ctl.this_func(); // run the function of the selected
                                        // submenu item to initialize it
                  // This function should complete quickly after initializing
                  // the display!!!
                } // if ( menu_ctl.this_func != NULL )
                menu_update_stat = MENU_UPDATE_RESET;
              } // if ( n_items != 0 )

              else if (pthis_submenu->submenu[menu_ctl.menu_item_active]
                           ->sub_func !=
                       NULL) // This menu item has no submenu. Does it have a
                             // function to run?
              {
                m1_device_stat.op_mode = M1_OPERATION_MODE_SUB_FUNC_RUNNING;
                m1_device_stat.sub_func =
                    pthis_submenu->submenu[menu_ctl.menu_item_active]
                        ->sub_func; // let schedule to run the function of the
                                    // selected submenu item
                // this_button_status.event[key].event = BUTTON_EVENT_IDLE; //
                // clear before return
                //  Notify the sub-function handler
                xTaskNotify(subfunc_handler_task_hdl, 0, eNoAction);
                // Wait for the sub-function to complete and notify this task
                // from subfunc_handler_task
                ...
                menu_update_stat =
                    MENU_UPDATE_REFRESH; // The sub-function may have changed
                                         // the GUI. It needs update.
              ...
              m1_device_stat.op_mode =
                  M1_OPERATION_MODE_MENU_ON; // update new state
            } // else if ( m1_device_stat.op_mode==M1_OPERATION_MODE_DISPLAY_ON
              // )
#ifdef BUTTON_REPEATED_PRESS_ENABLE
            else if (m1_device_stat.op_mode == M1_OPERATION_MODE_POWER_UP) {
              m1_device_stat.op_mode =
                  M1_OPERATION_MODE_DISPLAY_ON; // update new state
              m1_gui_welcome_scr();
            ...
            if (m1_device_stat.op_mode == M1_OPERATION_MODE_POWER_UP) {
              ...
              // m1_device_stat.op_mode = OPERATION_MODE_SHUTDOWN; // force to
              // sleep mode immediately System_Shutdown();
            } // else if ( m1_device_stat.op_mode==M1_OPERATION_MODE_MENU_ON )
          } // if (
            // this_button_status.event[BUTTON_OK_KP_ID]==BUTTON_EVENT_LCLICK )
#endif // #ifndef BUTTON_REPEATED_PRESS_ENABLE
          break;

        case BUTTON_UP_KP_ID:
          if (m1_device_stat.op_mode == M1_OPERATION_MODE_MENU_ON) {
            if (this_button_status.event[BUTTON_DOWN_KP_ID] ==
                BUTTON_EVENT_CLICK) // UP and DOWN pressed at the same time?
              break;                // Do nothing
            sel_item =
                menu_ctl.menu_item_active; // take the current active menu item
            if (sel_item == 0)             // first menu item?
            {
              sel_item = menu_ctl.num_menu_items - 1; // move to last menu item
              // menu_ctl.total_menu_items =
              // menu_ctl.main_menu_ptr[menu_ctl.menu_level]->submenu_items;
        ...
        case BUTTON_DOWN_KP_ID:
          if (m1_device_stat.op_mode == M1_OPERATION_MODE_MENU_ON) {
            if (this_button_status.event[BUTTON_UP_KP_ID] ==
                BUTTON_EVENT_CLICK) // UP and DOWN pressed at the same time?
              break;                // Do nothing
            sel_item =
                menu_ctl.menu_item_active; // take the current active menu item
        ...
        case BUTTON_LEFT_KP_ID:
          if (m1_device_stat.op_mode == M1_OPERATION_MODE_MENU_ON) {
            if (pthis_submenu->xkey_handler)
              pthis_submenu->xkey_handler(
                  this_button_status.event[BUTTON_LEFT_KP_ID],
                  BUTTON_LEFT_KP_ID, sel_item);
          } else if (m1_device_stat.op_mode == M1_OPERATION_MODE_DISPLAY_ON) {
            storage_explore();
            m1_gui_welcome_scr();
          }
        ...
        case BUTTON_RIGHT_KP_ID:
          if (m1_device_stat.op_mode == M1_OPERATION_MODE_MENU_ON) {
            if (pthis_submenu->xkey_handler)
              pthis_submenu->xkey_handler(
                  this_button_status.event[BUTTON_RIGHT_KP_ID],
                  BUTTON_RIGHT_KP_ID, sel_item);
          } else {
            ; // Do something here if necessary. This case may never happen!
          }
          break;
        ...
        case BUTTON_BACK_KP_ID:
          if (m1_device_stat.op_mode == M1_OPERATION_MODE_MENU_ON) {
            if (menu_update_stat != MENU_UPDATE_NONE) // Other buttons pressed?
              break; // Do nothing, let other buttons take their higher
                     // priority!
            if (menu_ctl.menu_level == 0) // already at main menu screen?
            {
              ...
              if (menu_ctl.num_menu_items) // Submenu with active items?
              {
                if (pthis_submenu->deinit_func)
                  pthis_submenu->deinit_func(); // Run deinit function of this
                                                // submenu before leaving
              } // if ( menu_ctl.num_menu_items )
              menu_ctl.menu_level--; // go back one level
              menu_ctl.menu_item_active =
                  menu_ctl.last_selected_items
                      [menu_ctl.menu_level]; // restore  previous selected item
                                             // of the upper menu level
              pthis_submenu =
                  menu_ctl
                      .main_menu_ptr[menu_ctl.menu_level]; // save the current
                                                           // menu level index
              menu_ctl.this_func = pthis_submenu->sub_func;
              ...
              if (menu_ctl.this_func != NULL) {
                ...
                // This function should complete quickly after initializing the
                // display!!!
              } // if ( menu_ctl.this_func != NULL )
