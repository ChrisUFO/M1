...
/* TIM prescaler is computed to have 1 μs as time base. TIM frequency (in MHz) /
 * (prescaler+1) */
#define BUZZER_PRESCALER 74 /*!< TIM prescaler */
#define BUZZER_TIMER_CLK                                                       \
  __HAL_RCC_TIM3_CLK_ENABLE /*!< Clock of the used timer */
...
#define BUZZER_PRESCALER 74 /*!< TIM prescaler */
#define BUZZER_TIMER_CLK                                                       \
  __HAL_RCC_TIM8_CLK_ENABLE /*!< Clock of the used timer */
...
#define BUZZER_FREQ_36KHZ_PERIOD                                               \
  2083 // clock tick period = 1/75MHz, carrier period = 1/36KHz = 75MHz/36KHz =
       // 2083 clock tick periods
