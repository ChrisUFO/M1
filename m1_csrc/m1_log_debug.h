...
#define M1_LOG_N(tag, format, ...)                                             \
  m1_logdb_printf(LOG_DEBUG_LEVEL_NONE, tag, format, ##__VA_ARGS__)
#define M1_LOG_E(tag, format, ...)                                             \
  m1_logdb_printf(LOG_DEBUG_LEVEL_ERROR, tag, format, ##__VA_ARGS__)
#define M1_LOG_W(tag, format, ...)                                             \
  m1_logdb_printf(LOG_DEBUG_LEVEL_WARN, tag, format, ##__VA_ARGS__)
#define M1_LOG_I(tag, format, ...)                                             \
  m1_logdb_printf(LOG_DEBUG_LEVEL_INFO, tag, format, ##__VA_ARGS__)
#define M1_LOG_D(tag, format, ...)                                             \
  m1_logdb_printf(LOG_DEBUG_LEVEL_DEBUG, tag, format, ##__VA_ARGS__)
#define M1_LOG_T(tag, format, ...)                                             \
  m1_logdb_printf(LOG_DEBUG_LEVEL_TRACE, tag, format, ##__VA_ARGS__)
...
extern size_t m1_logdb_get_recent(char *out, size_t max_len);
