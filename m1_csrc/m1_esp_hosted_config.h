...
#define CONFIG_ESP_HOSTED_MAX_SIMULTANEOUS_SYNC_RPC_REQUESTS                   \
  10 // Dummy number, should be adjusted properly later!
#define CONFIG_ESP_HOSTED_MAX_SIMULTANEOUS_ASYNC_RPC_REQUESTS                  \
  10 // Dummy number, should be adjusted properly later!

#define CONFIG_UNITY_FREERTOS_PRIORITY 5
#define CONFIG_UNITY_FREERTOS_CPU                                              \
  0 // ( ( BaseType_t ) 0x7FFFFFFF ) //tskNO_AFFINITY
#define CONFIG_UNITY_FREERTOS_STACK_SIZE 8192
// #define UNITY_FREERTOS_PRIORITY				5
// #define UNITY_FREERTOS_CPU					0 // ( (
// BaseType_t ) 0x7FFFFFFF ) //tskNO_AFFINITY #define UNITY_FREERTOS_STACK_SIZE
// 8192
...
#define CONFIG_UNITY_CRITICAL_LEAK_LEVEL_GENERAL                               \
  UNITY_CRITICAL_LEAK_LEVEL_GENERAL
...
#define WIFI_PROV_SCAN_MAX_ENTRIES                                             \
  16 // range 1-255, defined in
     // esp-idf-v5.3.1/components/wifi_provisioning/Kconfig
#ifndef CONFIG_WIFI_PROV_SCAN_MAX_ENTRIES
#define CONFIG_WIFI_PROV_SCAN_MAX_ENTRIES WIFI_PROV_SCAN_MAX_ENTRIES
#endif
#define WIFI_PROV_AUTOSTOP_TIMEOUT                                             \
  30 // range 5-600, defined in
     // esp-idf-v5.3.1/components/wifi_provisioning/Kconfig
