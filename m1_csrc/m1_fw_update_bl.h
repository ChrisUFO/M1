...
#define FW_CONFIG_RESERVED_ADDRESS                                             \
...
#define FW_UPDATE_FULL_PROGRESS_COUNT                                          \
  40 // Calculated based on the sizes of the slider and the slide strip
     // N = (124 - x_0)/(slider_width - overlap)
     // x_0 = 3, start column; 124 = slide strip width - 2
#define FW_UPDATE_FULL_PROGRESS_FACTOR                                         \
  (float)100 / FW_UPDATE_FULL_PROGRESS_COUNT
